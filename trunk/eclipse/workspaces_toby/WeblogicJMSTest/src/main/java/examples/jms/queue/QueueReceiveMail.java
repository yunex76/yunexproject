...
public class QueueReceiveMail implements MessageListener {
	    ...
	    try {
	     ...
	     if (msg instanceof TextMessage) {
	       msgText = ((TextMessage)msg).getText();
	    	 ...
	    	 mail = (Mail) ((ObjectMessage)msg).getObject();
	    	 msgText = mail.getCountry();
	     }
	     else {
	 ...
	 */
	 public static void main(String[] args) throws Exception {
	    ...
	    QueueReceiveMail qr = new QueueReceiveMail();
	    qr.init(ic, QUEUE);
